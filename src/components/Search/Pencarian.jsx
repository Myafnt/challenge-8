    ...
    <>
      <div class="card card-carimobil">
        <div class="card-body d-flex">
          <div className="card-content" style={{ maxWidth: 300, marginRight: 20 }}>
            <p class="mb-1">Tipe Driver</p>
            <Select placeholder="Pilih Tipe Driver" style={{ width: 220 }}>
              <Option value="1">Dengan Sopir</Option>
              <Option value="2">Tanpa Sopir (Lepas Kunci)</Option>
            </Select>
          </div>
          <div className="card-content" style={{ maxWidth: 220, marginRight: 20 }}>
            <p class="mb-1">Tanggal</p>
            <DatePicker style={{ width: 220 }} />
          </div>
          <div className="card-content" style={{ maxWidth: 220, marginRight: 20 }}>
            <p class="mb-1">Waktu Jemput/Ambil</p>
            <TimePicker use12Hours showNow={false} format="HH:mm" style={{ width: 220 }} />
          </div>
          <div className="card-content" style={{ maxWidth: 220, marginRight: 20 }}>
            <p class="mb-1">Jumlah Penumpang (Optional)</p>
            <Input placeholder="Jumlah Penumpang" style={{ width: 220 }} />
          </div>
